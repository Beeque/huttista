...
echo Building NHL Card Monitor Auto v10 with division/league fix...
...
if %BUILD_RESULT% equ 0 (
    ...
    echo   - NEW: Division/League validation - if division is "Division" or empty,
    echo     both division and league fields are removed (not set to NHL)
    echo   - Automatic monitoring and updating
    echo.
    echo 📊 Now all data is perfect and division/league handling is fixed!
    echo.
    pause
) else (
    echo.
