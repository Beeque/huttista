#!/usr/bin/env python3
"""
Czechia Complete Fetcher
Fetches all Czechia players (skaters + goalies) with complete data
"""
...
def fetch_skaters_with_timeout(nationality, max_retries=3, timeout=30):
    ...
    print(f"🏒 Fetching Czechia skaters...")
...
def run_czechia_fetcher():
    """Main function to fetch all Czechia players"""
    print("🇨🇿 CZECHIA COMPLETE FETCHER")
    print("=" * 50)
    
    # Fetch skaters
    print("\n1️⃣ FETCHING SKATERS")
    skaters = fetch_skaters_with_timeout('Czechia')
