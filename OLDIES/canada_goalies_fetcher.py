#!/usr/bin/env python3
"""
Canada Goalies Fetcher
Fetches Canada goalies separately and merges with existing data
"""
...
def run_canada_goalies_fetcher():
    """Main function to fetch Canada goalies and merge with existing data"""
    print("🇨🇦 CANADA GOALIES FETCHER")
    print("=" * 50)
