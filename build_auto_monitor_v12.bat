...
echo Building NHL Card Monitor Auto v12 with debug logging...
...
if %BUILD_RESULT% equ 0 (
    ...
    echo   - NEW: Debug logging for missing URLs detection
    echo   - Automatic monitoring and updating
    echo.
    echo 📊 Now with debug logging to fix missing URLs detection!
    echo.
    pause
) else (
    echo.
