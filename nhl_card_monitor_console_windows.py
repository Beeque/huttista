#!/usr/bin/env python3
"""
NHL Card Monitor - Windows Console Version
Automaattinen korttien seuranta konsoli-ympäristössä (Windows-yhteensopiva)
"""
...
class NHLCardMonitorConsoleWindows:
    def __init__(self):
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('nhl_monitor_console.log', encoding='utf-8'),
    ...
    def print_menu(self):
        ...
        print("2. [START] Aloita automaattinen seuranta")
        print("3. [STOP]  Pysayta seuranta")
        print("4. [ENRICH] Rikasta X-Factor tiedot")
        print("5. [RELOAD] Lataa master.json uudelleen")
        print("6. [STATS] Nayta tilastot")
        print("7. [EXIT]  Lopeta")
        print("-" * 40)
    ...
    def load_master_data(self):
        ...
        try:
            ...
            if self.master_data:
                ...
                self.log_message("Epaonnistui master.json:n lataaminen", "ERROR")
                return False
...
def main():
    """Main function"""
    monitor = NHLCardMonitorConsoleWindows()
    monitor.run()
