...
echo Building NHL Card Monitor Auto v11 with goalie stats fix...
...
if %BUILD_RESULT% equ 0 (
    ...
    echo   - NEW: Complete goalie stats parsing:
    ...
    echo.
    echo 📊 Now all data is perfect including complete goalie stats!
    echo.
    pause
) else (
    echo.
