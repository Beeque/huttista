#!/usr/bin/env python3
"""
Australia Complete Fetcher
Fetches all Australia players (skaters + goalies) with complete data
"""
...
def fetch_skaters_with_timeout(nationality, max_retries=3, timeout=30):
    ...
    print(f"🏒 Fetching Australia skaters...")
...
def fetch_goalies_with_timeout(nationality, max_retries=3, timeout=30):
    ...
    print(f"🥅 Fetching Australia goalies...")
...
def run_australia_fetcher():
    """Main function to fetch all Australia players"""
    print("🇦🇺 AUSTRALIA COMPLETE FETCHER")
    print("=" * 50)
    
    # Fetch skaters
    print("\n1️⃣ FETCHING SKATERS")
    skaters = fetch_skaters_with_timeout('Australia')
    
    # Fetch goalies  
    print("\n2️⃣ FETCHING GOALIES")
    goalies = fetch_goalies_with_timeout('Australia')
