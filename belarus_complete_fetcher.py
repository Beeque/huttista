#!/usr/bin/env python3
"""
Belarus Complete Fetcher
Fetches all Belarus players (skaters + goalies) with complete data
"""
...
def fetch_skaters_with_timeout(nationality, max_retries=3, timeout=30):
    ...
    print(f"🏒 Fetching Belarus skaters...")
...
def fetch_goalies_with_timeout(nationality, max_retries=3, timeout=30):
    ...
    print(f"🥅 Fetching Belarus goalies...")
...
def run_belarus_fetcher():
    """Main function to fetch all Belarus players"""
    print("🇧🇾 BELARUS COMPLETE FETCHER")
    print("=" * 50)
    
    # Fetch skaters
    print("\n1️⃣ FETCHING SKATERS")
    skaters = fetch_skaters_with_timeout('Belarus')
    
    # Fetch goalies  
    print("\n2️⃣ FETCHING GOALIES")
    goalies = fetch_goalies_with_timeout('Belarus')
