...
if exist "C:\Python313\python.exe" (
    ...
    echo Found Python: C:\Python313\python.exe
    goto :found_python
)
...
if exist "%USERPROFILE%\AppData\Local\Programs\Python\Python39\python.exe" (
    ...
    echo Found Python: %USERPROFILE%\AppData\Local\Programs\Python\Python39\python.exe
    goto :found_python
)
...
if exist "%USERPROFILE%\AppData\Local\Programs\Python\Python310\python.exe" (
    ...
    echo Found Python: %USERPROFILE%\AppData\Local\Programs\Python\Python310\python.exe
    goto :found_python
)

if exist "%USERPROFILE%\AppData\Local\Programs\Python\Python311\python.exe" (
    set PYTHON_CMD=%USERPROFILE%\AppData\Local\Programs\Python\Python311\python.exe
    echo Found Python: %USERPROFILE%\AppData\Local\Programs\Python\Python311\python.exe
    goto :found_python
)

if exist "%USERPROFILE%\AppData\Local\Programs\Python\Python312\python.exe" (
    set PYTHON_CMD=%USERPROFILE%\AppData\Local\Programs\Python\Python312\python.exe
    echo Found Python: %USERPROFILE%\AppData\Local\Programs\Python\Python312\python.exe
    goto :found_python
)
...
if exist "%USERPROFILE%\AppData\Local\Programs\Python\Python313\python.exe" (
    ...
    echo Found Python: %USERPROFILE%\AppData\Local\Programs\Python\Python313\python.exe
    goto :found_python
)
