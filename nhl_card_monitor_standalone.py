#!/usr/bin/env python3
"""
NHL Card Monitor - Standalone Version (No Dependencies)
...
if sys.platform == "win32":
    try:
        ...
        pass  # If it fails, continue without encoding change

class NHLCardMonitorStandalone:
    def __init__(self):
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('nhl_monitor_standalone.log', encoding='utf-8'),
    ...
    def print_banner(self):
        ...
        print("=" * 60)
        print("NHL CARD MONITOR - STANDALONE VERSION")
        print("=" * 60)
...
def main():
    """Main function"""
    monitor = NHLCardMonitorStandalone()
    monitor.run()
