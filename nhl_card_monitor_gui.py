#!/usr/bin/env python3
"""
NHL Card Monitor - GUI Version with Login
...
class NHLCardMonitorGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("🏒 NHL Card Monitor - GUI Version")
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('nhl_monitor_gui.log', encoding='utf-8'),
    ...
    def show_login(self):
        ...
        # Login frame
        login_frame = tk.Frame(self.root, bg='#2b2b2b', padx=50, pady=50)
        login_frame.pack(expand=True, fill='both')
        
        # Title
        title_label = tk.Label(login_frame, text="🏒 NHL Card Monitor", 
                              font=('Arial', 24, 'bold'), 
                              bg='#2b2b2b', fg='white')
        title_label.pack(pady=(0, 30))
        
        # Subtitle
        subtitle_label = tk.Label(login_frame, text="Automaattinen korttien seuranta", 
                                 font=('Arial', 12), 
                                 bg='#2b2b2b', fg='#cccccc')
        subtitle_label.pack(pady=(0, 40))
        
        # Login form
        form_frame = tk.Frame(login_frame, bg='#2b2b2b')
        form_frame.pack()
        
        # Username
        tk.Label(form_frame, text="Käyttäjänimi:", 
                font=('Arial', 10), bg='#2b2b2b', fg='white').pack(anchor='w')
        self.username_entry = tk.Entry(form_frame, font=('Arial', 12), width=30)
        self.username_entry.pack(pady=(5, 15))
        
        # Password
        tk.Label(form_frame, text="Salasana:", 
                font=('Arial', 10), bg='#2b2b2b', fg='white').pack(anchor='w')
        self.password_entry = tk.Entry(form_frame, font=('Arial', 12), width=30, show='*')
        self.password_entry.pack(pady=(5, 20))
        
        # Login button
        login_btn = tk.Button(form_frame, text="Kirjaudu sisään", 
                             font=('Arial', 12, 'bold'),
                             bg='#4CAF50', fg='white', 
                             padx=30, pady=10,
                             command=self.login)
        ...
        # Demo button
        demo_btn = tk.Button(form_frame, text="Demo-tila (ei kirjautumista)", 
                            font=('Arial', 10),
                            bg='#2196F3', fg='white', 
                            padx=20, pady=5,
    ...
    def login(self):
        ...
        if not username or not password:
            messagebox.showerror("Virhe", "Syötä käyttäjänimi ja salasana!")
            return
        ...
        if username == "admin" and password == "admin":
            ...
            messagebox.showerror("Virhe", "Väärä käyttäjänimi tai salasana!")
    ...
    def create_main_gui(self):
        ...
        # Logout button
        logout_btn = tk.Button(title_frame, text="Kirjaudu ulos", 
                              font=('Arial', 10),
                              bg='#f44336', fg='white', 
                              padx=15, pady=5,
                              command=self.logout)
