#!/usr/bin/env python3
"""
Toimiva NHL HUT Builder Web Scraper
Käyttää requests-kirjastoa paremmilla headerilla
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('working_nhl_scraper.log'),
...
class WorkingNHLScraper:
    def __init__(self, db_path: str = 'nhl_cards_working.db'):
        self.base_url = 'https://nhlhutbuilder.com'
        self.db_path = db_path
        self.session = requests.Session()
        
        # Simuloi oikeaa selainta mahdollisimman hyvin
    ...
    def get_page_content(self, url: str, retries: int = 3) -> Optional[str]:
        ...
        for attempt in range(retries):
            try:
                ...
                # Lisää referer-header
                if 'player-stats.php' in url:
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Working NHL HUT Builder Web Scraper')
